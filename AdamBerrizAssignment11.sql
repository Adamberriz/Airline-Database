...
INSERT INTO `employee` VALUES (1,'Paris','Lindsey','763 West Mulberry St','29710','2025550132','plindsey@isp.com'),(2,'Umaiza','Melia','545 Ohio Ave','29710','2025550135','umelia@isp.com'),(3,'Nico','Prince','20 Middle River Street','44094','2025550137','nprince@isp.com'),(4,'Javan','Rennie','8112 North Country St','44094','2025550139','jrennie@isp.com'),(5,'Ali','Waters','83 Rockland Lane','44094','2025550144','awaters@isp.com'),(6,'JohnPaul','Clarke','1 Riverside Lane','44094','2025550153','jpcClarke@isp.com'),(7,'Dane','Kaiser','694 Wall Road','44094','2025550155','kdaiser@isp.com'),(8,'Hammad','Newman','9970 State Court','30096','2025550157','hnewman@isp.com'),(9,'Maha','Guthrie','54 Woodsman Drive','30096','2025550161','mguthrie@isp.com'),(10,'Tulisa','Roberts','7174 Studebaker Street','30096','2025550163','troberts@isp.com'),(11,'Raheem','Montgomery','71 Paris Hill Rd.','39180','4134849795','rmontgomery@cruise.com'),(13,'Oliwier','Barnett','81 Cedar Swamp St.','39180','2764343958','obarnett@cruise.com'),(15,'Dawson','Marquez','90 Mammoth Street','45601','7634882879','dmarquez@cruise.com'),(16,'Raja','Glass','7918 Talbot Ave.','45601','2319969540','rglass@cruise.com'),(18,'Nicholas','Pena','8123 Race Ave.','95060','7815242242','npena@cruise.com'),(20,'Aamina','Dillon','9 West Boston Lane','95060','2035745299','adillon@cruise.com'),(22,'Krystal','Walters','583 North Nichols Street','95060','3232591832','kwalters@cruise.com'),(30,'Kaya','Hodge','9572 William Lane','46060','2125271561','khodge@cruise.com'),(34,'Brodie','Gordon','71 Jackson Ave.','46060','9016899813','bgordon@cruise.com'),(38,'Mathew','Horton','1 Rockland Ave.','46060','7195789907','mhorton@cruise.com'),(71,'Leo','Bird','201 Eagle Dr.','12020','7747829407','lbird@cruise.com'),(73,'Fern','Garner','37 Gartner Court','12020','2256254378','fgarner@cruise.com'),(83,'Rebekah','Morgan','9437 East 6th Street','20601','6073928343','rmorgan@cruise.com'),(85,'Malik','Vincent','312 Colonial Ave.','19083','9149573014','mvincent@cruise.com'),(87,'Lyra','Murphy','400 Nut Swamp Drive','19083','3527673126','lmurphy@cruise.com'),(91,'Laila','Christensen','15 Rose Avenue','07501','9017396978','lchristensen@cruise.com'),(95,'Ty','Bell','921 Brook St.','07501','2393336881','tbell@cruise.com'),(99,'Kamil','Lozano','75 N. Golden Star Street','07501','7638554744','klozano@cruise.com'),(141,'Alissa','Ortiz','7756 Fulton Court','23832','2397268929','aortiz@cruise.com'),(143,'Harvey','West','9 Cherry Ave','23832','7326232762','hwest@cruise.com'),(145,'Louis','Giles','598 North Road','28115','2708583758','lgiles@cruise.com'),(147,'Alexa','Preston','9227 North Bow Ridge Street','28115','4098496634','apreston@cruise.com'),(149,'Ethan','Ali','167 NE. Depot Dr.','28115','2245499884','eali@cruise.com'),(151,'Sara','Barron','9064 E. Swanson St.','20601','8707743244','sbarron@cruise.com'),(153,'Awais','Carrillo','225 South Manhattan Street','28079','6369577670','acarrillo@cruise.com'),(155,'Jemima','Miller','9290 Indian Spring Rd.','28079','6206673264','jmiller@cruise.com'),(157,'Honey','Warren','7946 Leeton Ridge Street','06611','5858531050','hwarren@cruise.com'),(159,'Lauren','Morton','7931 Rockaway Street','28079','4476721422','lmorton@cruise.com'),(161,'Floyd','Johns','2 Shore Street','06611','4065842872','fjohns@cruise.com'),(163,'Ernest','Higgins','451 Marshall Lane','06611','7637651247','ehiggins@cruise.com');
...
INSERT INTO `timesheet` VALUES (1,163,0,8,8,8,8,8,0),(2,145,6,6,6,6,6,5,0),(3,73,0,12,6,10,6,8,0),(4,10,10,8,0,0,8,10,10),(5,2,8,8,0,0,8,10,6),(6,87,0,12,6,10,6,8,0),(7,157,8,8,0,0,8,10,6),(8,141,0,8,8,8,8,8,0),(9,155,10,8,0,0,8,10,10),(10,91,12,0,12,0,4,12,0),(11,30,0,12,6,10,6,8,0),(12,153,12,0,12,0,4,12,0),(13,83,6,6,6,6,6,5,0),(14,22,8,8,0,0,8,10,6),(15,11,0,8,8,8,8,8,0),(16,1,10,8,0,0,8,10,10),(17,6,12,0,12,0,4,12,0),(18,13,0,12,6,10,6,8,0),(19,20,7,4,9,0,0,10,3),(20,38,6,6,6,6,6,5,0),(21,15,12,0,12,0,4,12,0),(22,161,0,8,8,8,8,8,0),(23,159,7,4,9,0,0,10,3),(24,151,10,8,0,0,8,10,10),(25,149,7,4,9,0,0,10,3),(26,147,0,12,6,10,6,8,0),(27,143,12,0,12,0,4,12,0),(28,3,6,6,6,6,6,5,0),(29,4,7,4,9,0,0,10,3),(30,5,0,8,8,8,8,8,0),(31,99,10,8,0,0,8,10,10),(32,95,12,0,12,0,4,12,0),(33,71,6,6,6,6,6,5,0),(34,7,8,8,0,0,8,10,6),(35,8,0,8,8,8,8,8,0),(36,9,10,8,0,0,8,10,10),(37,85,0,12,6,10,6,8,0),(38,34,6,6,6,6,6,5,0),(39,18,8,8,0,0,8,10,6),(40,16,0,8,8,8,8,8,0);
...
/*!50001 VIEW `airlinemanifestview` AS select concat(`e`.`firstname`,' ',`e`.`lastname`) AS `Name`,`e`.`phone` AS `PhoneNumber`,`p`.`description` AS `Role`,`f`.`origin` AS `Origin`,`f`.`departure` AS `Departure`,`f`.`destination` AS `Destination`,`f`.`arrival` AS `Arrival` from ((((`employee` `e` join `employeeflight` `ef` on((`e`.`ID` = `ef`.`employeeId`))) join `flight` `f` on((`ef`.`flightId` = `f`.`ID`))) join `employeeposition` `ep` on((`e`.`ID` = `ep`.`employeeId`))) join `position` `p` on((`ep`.`positionId` = `p`.`ID`))) union select concat(`p`.`firstName`,' ',`p`.`lastName`) AS `Name`,`p`.`phone` AS `PhoneNumber`,'Passenger' AS `Role`,`f`.`origin` AS `Origin`,`f`.`departure` AS `Departure`,`f`.`destination` AS `Destination`,`f`.`arrival` AS `Arrival` from ((`passenger` `p` join `passengerflight` `pf` on((`p`.`ID` = `pf`.`passengerId`))) join `flight` `f` on((`pf`.`flightId` = `f`.`ID`))) */;
...
-- Dump completed on 2023-12-03 23:05:52
